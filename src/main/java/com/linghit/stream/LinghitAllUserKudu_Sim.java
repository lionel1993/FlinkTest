 ...
 */
public class LinghitAllUserKudu_Sim {
    ...
    private final static String USER_EVENT_TABLE = "linghit_all_userevent_kudu_test"; // linghit_all_userevent_kudu
    /**
...
//        consumer.setStartFromLatest();
      ...
      /*  获取 KUDU Sink
        ...
        }).addSink(kuduSink);// Flink添加自定义sink
...
//        subUserInfoMap.put("first_time", 1577808009);
...
////        userEventRow.setTableName("impala::dev_linghit_dw_dwd.linghit_all_userevent_test");
...
//        KuduRow userInfoRow = new KuduRow(5);
//        userInfoRow.setField(0,Constant.LINGHIT.linghit_id, "d3e8173dd4894244b55200119895a0e2");
//        userInfoRow.setField(1,Constant.LINGHIT.first_time, 1577808001);
//        userInfoRow.setField(2,Constant.LINGHIT.app_id, "X01");
//        userInfoRow.setField(3,"cookie", "8888888888");
//        userInfoRow.setTableName(USER_TABLE);
//        kuduRowList.add(userInfoRow);
//        System.out.println("kuduRowList:"+kuduRowList);
...
//        userInfoRow.setField(0,Constant.LINGHIT.linghit_id, "d3e8173dd4894244b55200119895a0e2");
//        userInfoRow.setField(1,Constant.LINGHIT.first_time, 1577808003);
//        userInfoRow.setField(2,Constant.LINGHIT.app_id, "X01");
//        userInfoRow.setTableName(USER_TABLE);
//        kuduRowList.add(userInfoRow);
//        System.out.println("kuduRowList:"+kuduRowList);
